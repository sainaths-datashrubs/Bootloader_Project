...
# 50 "mcc_generated_files/bootload.h"
typedef union
{
    struct
    {
...
# 228 "mcc_generated_files/pic18f_bootload.c"
...
# 271 "mcc_generated_files/pic18f_bootload.c"
uint8_t Write_Flash()
{
...
# 312 "mcc_generated_files/pic18f_bootload.c"
uint8_t Erase_Flash ()
{
    TBLPTRL = frame.address_L;
    TBLPTRH = frame.address_H;
    TBLPTRU = frame.address_U;
    if ((TBLPTR & (~(128 - 1))) < 0x300)
    {
        frame.data[0] = 0xFE;
        return (10);
    }
...
# 346 "mcc_generated_files/pic18f_bootload.c"
uint8_t Read_Config ()
{
    TBLPTRL = frame.address_L;
    TBLPTRH = frame.address_H;
...
# 406 "mcc_generated_files/pic18f_bootload.c"
